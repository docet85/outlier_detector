...
def filter_outlier(distribution_id=None, strategy='recursion', **outlier_detector_kwargs):
    ...
    def recursive_outlier_filter_generator(func):
        def wrapper(*args, **kwargs):
            od = _retrieve_filter_instance(func, args, d_id, distribution_id, **outlier_detector_kwargs)
...
def _retrieve_filter_instance(func, args, d_id, distribution_id, **outlier_detector_kwargs):
